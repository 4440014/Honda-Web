...
<div class="container">
    <div class="row">
                    ...
                    <form action="">
                        ...
                        <div class="form-group">
                            ...
                            <select id="city" name="city" class="form-control" required="required">
                                ...
                                <option value="suggestions">Islamabad</option>
                                <option value="product">Karachi</option>
                            </select>
                        </div>
                         <div class="form-group">
                            <label for="name">
        ...
        <div class="col-md-6">
            ...
            <address>
                <strong>Honda Customer Service</strong><br>
                Business hours: 9:00 am - 6:00 pm <br>
                By Phone: PABX: +92-(0)304 1118 882 <br>
                By Mail: info@honda.com.pk <br>
            ...
            <address>
                ...
                Hours of Operation: 8:00 am - 5:00 pm<br>
                Tel: +92-(0)42-35384671-80<br>
                Fax: +92-(0)42-35384691-92<br>
                 E-mail: info@honda.com.pk <br>
                <strong>Office:<br> </strong>
                HONDA Atlas Cars (Pakistan) Limited 
                Asia House, 19 - C & D, Block L, 
                Gulberg III, Main Ferozepur Road, Lahore.
            </address>
            </form>
            <div id="map" style="width:400px;height:320px;background:yellow"></div>
